...
class SeedAccountResult(BaseModel):
    ...
    Attributes:
        ...
        virtual_cards: list[SeedCardResult]: Список виртуальных карт, привязанных к счету.
        transfer_operations: list[SeedOperationResult]: Список операций переводов
        cash_withdrawal_operations: list[SeedOperationResult] Список операций снятия
    """
    account_id: str
