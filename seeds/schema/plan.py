...
class SeedAccountsPlan(BaseModel):
    ...
    Attributes:
        ...
        virtual_cards (SeedCardsPlan) План по созданию виртуальной карты
        transfer_operations (SeedOperationsPlan) План по переводу
        cash_withdrawal_operations(SeedOperationsPlan) План по операции снятия
    """
    count: int = 0
