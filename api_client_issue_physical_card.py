...
#Импортируются билдер функции для создания HTTP-клиентов.
users_gateway_client = build_users_gateway_http_client()#для взаимодействия с /api/v1/users
cards_gateway_client = build_cards_gateway_http_client()#/api/v1/cards
accounts_gateway_client = build_accounts_gateway_http_client()#/api/v1/accounts
