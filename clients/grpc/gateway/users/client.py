...
class UsersGatewayGRPCClient(GRPCClient):
    ...
    def __init__(self, channel: Channel):
        ...
        # Использование super() обеспечивает корректное выполнение инициализации
        # родительского класса GRPCClient. Это позволяет:
        # 1. Переиспользовать логику инициализации из базового класса
        # 2. Правильно работать в цепочке наследования (особенно важно при множественном наследовании)
        # 3. Соблюдать принцип DRY - не дублировать код инициализации
        # 4. Гарантировать, что родительский класс будет правильно инициализирован
        # перед дочерним классом
