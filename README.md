...
Тесты предназначены для проверки производительности банковского тестового стенда, развёрнутого локально:
[Стенд](https://github.com/DmitriyFrolov2/performance-testing-environment)
...
Перед загрузкой результатов необходимо зарегистрировать сервис
